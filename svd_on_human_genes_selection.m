...
ss = 1;
X = X(1:ss:end,selection.highConfGenes);
...
%% Save mapped data
save('SVDMouseGenesSelection','X','mappedXc','mappedX','coords',...
    'M','lambda');
...
saveas(1,'SVDMouseGeneCoordsSelection');
...
saveas(2,'SVDMouseGenesSelection');
...
save('SVDMouseGeneVolumeSelection','imgr','imgg','imgb');
