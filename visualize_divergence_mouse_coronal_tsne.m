...
%% Data
resultsdatadir = [LUMCDATADIR 'tSNE_ABA/normalized/results_mouse_genes_selection_pca_sweep10/'];
datadir = [LUMCDATADIR 'tSNE_ABA/AllenMouseBrain_coronal/'];
% Load mapped data
load([resultsdatadir 'MappedMouseGenesSelection2Did10.mat'],'mappedX');
% Load voxel labels
...
saveas(1,'figure1f_tsne.eps','epsc2');
