...
geneselvec = selection.highConfGenes_sagittal;
...
%% Save mapped data
save([outdir sprintf('MappedMouseGenesSelection2Dsagittalperp%d',perplexity)],'X','mappedX','coords',...
...
saveas(3,[outdir sprintf('MappedMouseGeneSelection2Dsagittalperp%d',perplexity)]);
saveas(3,[outdir sprintf('MappedMouseGeneSelection2Dsagittalperp%d.png',perplexity)]);
...
save([outdir sprintf('MappedMouseGeneVolumeSelection2Dsagittalperp%d',perplexity)],'imgr','imgg','imgb');
