...
outdir = 'results_mouse_highConf_sagittal_SVD/';
...
ss = 1;
X = X(1:ss:end,selection.highConfGenes_sagittal);
...
%% Save mapped data
save([outdir 'SVDMouseGenesSelectionMeanSubSagittal'],'X','mappedXc','mappedX','coords',...
    'M','lambda');
...
saveas(1,[outdir 'SVDMouseGeneCoordsSelectionMeanSubSagittal']);
...
saveas(2,[outdir 'SVDMouseGenesSelectionMeanSubSagittal']);
...
save([outdir 'SVDMouseGeneVolumeSelectionMeanSubSagittal'],'imgr','imgg','imgb');
...
save([outdir 'SVDMouseGeneVolumeSelectionMeanSubSagittalAllcomponents'],'-v7.3','cimg');
