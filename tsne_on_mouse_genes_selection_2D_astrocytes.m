...
for inr = 1:nids
    ...
    geneselvec = selection.highConfGenes_coronal(cellselection.geneSubSets.astrocytes);
    ...
    %% Save mapped data
    save([outdir sprintf('MappedMouseGenesSelection2Dastrocytesid%d',initial_dims)],'X','mappedX','coords',...
    ...
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2Dastrocytes%d',initial_dims)]);
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2Dastrocytes%d.png',initial_dims)]);
    ...
    save([outdir sprintf('MappedMouseGeneVolumeSelection2Dastrocytesid%d',initial_dims)],'imgr','imgg','imgb');
end
