...
cellselection = load([datadir 'cell_type_genes_indices_coronal']);
...
for inr = 1:nids
    ...
    geneselvec = selection.highConfGenes_coronal(cellselection.geneSubSets.oligodendrocytes);
    ...
    %% Save mapped data
    save([outdir sprintf('MappedMouseGenesSelection2Doligodendrocytesid%d',initial_dims)],'X','mappedX','coords',...
    ...
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2Doligodendrocytes%d',initial_dims)]);
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2Doligodendrocytes%d.png',initial_dims)]);
    ...
    save([outdir sprintf('MappedMouseGeneVolumeSelection2Doligodendrocytesid%d',initial_dims)],'imgr','imgg','imgb');
end
