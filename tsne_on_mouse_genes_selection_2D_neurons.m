...
for inr = 1:nids
    ...
    geneselvec = selection.highConfGenes_coronal(cellselection.geneSubSets.neurons);
    ...
    %% Save mapped data
    save([outdir sprintf('MappedMouseGenesSelection2Dneuronsid%d',initial_dims)],'X','mappedX','coords',...
    ...
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2Dneurons%d',initial_dims)]);
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2Dneurons%d.png',initial_dims)]);
    ...
    save([outdir sprintf('MappedMouseGeneVolumeSelection2Dneuronsid%d',initial_dims)],'imgr','imgg','imgb');
end
