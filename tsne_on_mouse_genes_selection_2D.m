...
for inr = 1:nids
    ...
    %% Save mapped data
    save([outdir sprintf('MappedMouseGenesSelection2Did%d',initial_dims)],'X','mappedX','coords',...
    ...
    saveas(3,[outdir sprintf('MappedMouseGeneSelection2Did%d',initial_dims)]);
    saveas(3,[outdir sprintf('MappedMouseGeneSelection2Did%d.png',initial_dims)]);
    ...
    save([outdir sprintf('MappedMouseGeneVolumeSelection2Did%d',initial_dims)],'imgr','imgg','imgb');
end
