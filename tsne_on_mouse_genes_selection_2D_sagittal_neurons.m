...
for inr = 1:nids
    ...
    geneselvec = selection.highConfGenes_sagittal(cellselection.geneSubSets.neurons);
    ...
    %% Save mapped data
    save([outdir sprintf('MappedMouseGenesSelection2DsagittalNeuronsid%d',initial_dims)],'X','mappedX','coords',...
    ...
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2DsagittalNeurons%d',initial_dims)]);
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2DsagittalNeurons%d.png',initial_dims)]);
    ...
    save([outdir sprintf('MappedMouseGeneVolumeSelection2DsagittalNeuronsid%d',initial_dims)],'imgr','imgg','imgb');
end
