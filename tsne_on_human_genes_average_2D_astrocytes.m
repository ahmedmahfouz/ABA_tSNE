...
for bnr = 1:nbrains
    ...
    X0 = X0(:,genetypes.geneSubSets.astrocytes);
    X0 = zscore(X0,0,1);
    ...
    for inr = 1:nids
        ...
        %% Save mapped data
        save([outdir sprintf('MappedHumanGenesAverage2Dastrocytes%sid%d',id,initial_dims)],'X','mappedX','coords',...
        ...
        saveas(2,[outdir sprintf('MappedHumanGenesAverageRegions2Dastrocytes%sid%d',id,initial_dims)]);
    end
end
