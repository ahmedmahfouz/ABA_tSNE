...
for inr = 1:nids
    ...
    geneselvec = selection.highConfGenes_sagittal(cellselection.geneSubSets.astrocytes);
    ...
    %% Save mapped data
    save([outdir sprintf('MappedMouseGenesSelection2DsagittalAstrocytesid%d',initial_dims)],'X','mappedX','coords',...
    ...
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2DsagittalAstrocytes%d',initial_dims)]);
    saveas(3,[outdir sprintf('MappedMouseGenesSelection2DsagittalAstrocytes%d.png',initial_dims)]);
    ...
    save([outdir sprintf('MappedMouseGeneVolumeSelection2DsagittalAstrocytesid%d',initial_dims)],'imgr','imgg','imgb');
end
