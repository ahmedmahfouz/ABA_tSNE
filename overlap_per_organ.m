...
%% Data
resultsdatadir = [LUMCDATADIR 'tSNE_ABA/normalized/results_mouse_highConf_coronal_SVD/'];
datadir = [LUMCDATADIR 'tSNE_ABA/AllenMouseBrain_coronal/'];
% Load mapped data
load([resultsdatadir 'SVDMouseGenesSelectionMeanSub'],'mappedX');
% Load voxel labels
...
saveas(1,[resultsdatadir 'jsdiv_mouse_coronal_SVD.eps'],'epsc');
