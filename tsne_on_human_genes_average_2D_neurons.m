...
for bnr = 1:nbrains
    ...
    X0 = X0(:,genetypes.geneSubSets.neurons);
    X0 = zscore(X0,0,1);
    ...
    for inr = 1:nids
        ...
        %% Save mapped data
        save([outdir sprintf('MappedHumanGenesAverage2Dneurons%sid%d',id,initial_dims)],'X','mappedX','coords',...
        ...
        saveas(2,[outdir sprintf('MappedHumanGenesAverageRegions2Dneurons%sid%d',id,initial_dims)]);
    end
end
